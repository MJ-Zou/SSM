...
<body>
<!--  -->
<form id="userAction_save_do" name="Form1" action="${pageContext.request.contextPath}/editProduct"
    ...
    <table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee"
        ...
        <tr>
            ...
            <td class="ta_01" bgColor="#ffffff">
                <input type="text" name="marketPrice" value="${product.marketPrice}" id="userAction_save_do_logonName"
                       class="bg"/>
            </td>
            <td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
                商城价格：
            ...
            <td class="ta_01" bgColor="#ffffff">
                <input type="text" name="shopPrice" value="${product.shopPrice}" id="userAction_save_do_logonName"
                       class="bg"/>
            </td>
        </tr>
        <tr>
