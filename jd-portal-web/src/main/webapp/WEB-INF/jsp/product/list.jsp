...
<HEAD>
    ...
    <script type="text/javascript">
        function addProduct() {
            window.location.href = "${pageContext.request.contextPath}/toAddProduct";
        }
    </script>
</HEAD>
<body>
                    ...
                    <c:forEach items="${productList}" var="p" varStatus="vs">
                        <tr onmouseover="this.style.backgroundColor = 'white'"
                            ...
                            <td style="CURSOR: hand; HEIGHT: 22px" align="center"
                                ...
                                <c:if test="${p.isHot!=1 }">否</c:if>
                            </td>
                            <td align="center" style="HEIGHT: 22px">
                                <a href="${pageContext.request.contextPath }/toEditProduct/${p.pid}">
                            ...
                            <td align="center" style="HEIGHT: 22px">
                                <a href="${ pageContext.request.contextPath }/delProduct/${p.pid}"
                                   onclick="confirm('确认删除 ${p.pname} 吗')">
