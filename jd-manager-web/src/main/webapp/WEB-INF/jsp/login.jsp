                ...
                <form class="form-horizontal" method="post"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="password" class="form-control" id="inputPassword3"
                                   placeholder="请输入密码" name="password" value="${pwd}">
                        </div>
                    </div>
                    <%--<div class="form-group">--%>
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10">
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" name="autoLog" value="1" id="autoLog"> 自动登录
                                </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <label>
                                    <input type="checkbox" name="rememberUser" value="1" id="remember">记住用户名和密码
                                </label>
                            </div>
                        </div>
                    </div>
