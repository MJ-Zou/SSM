    ...
    <div class="col-md-3" style="padding-top:20px">
        <ol class="list-inline">
            ...
            <c:if test="${not empty user}">
                <li>欢迎你&nbsp;${user.name}</li>
                <li><a href="${pageContext.request.contextPath}/order_list/1">我的订单</a></li>
                <li><a href="${pageContext.request.contextPath}/cart">购物车</a></li>
...
<script>
    $(function () {
        $.get("${pageContext.request.contextPath}/getCat", function (data) {
            var $ul = $("#menuId");
            $(data).each(function () {
                $ul.append("<li><a href="
                    + "${pageContext.request.contextPath}\\product_list\\"+this.cid+"\\1>"
                + this.cname + "</a></li>");
            });
        }, "json")
    });
